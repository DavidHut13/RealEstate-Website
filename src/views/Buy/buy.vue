    ...
    <b-row>
        ...
        <b-col md="12" lg="7" 2xl="5" 3xl="4" class="resultsSide">
            <b-row v-if="filteredList.length > 0">
                ...
                <b-col cols="10" offset="1" sm="6" offset-sm="0" md="4" lg="6" class="resultsCols" v-for="(property, index) in filteredList" :key="index">
        ...
        <b-col class="mobileFilter" cols="12">
            <b-button block class="filterBtn mb-2" v-b-toggle.filters variant="none">filter</b-button>
